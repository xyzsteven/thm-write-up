...
We are provided with a Python script [`source.py`](assets/py/source-1705339805281.py) that runs on the target server. Let's analyze the core encryption logic:
